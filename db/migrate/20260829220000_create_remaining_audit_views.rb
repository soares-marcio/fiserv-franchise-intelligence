class CreateRemainingAuditViews < ActiveRecord::Migration[8.1]
  def up
    execute <<~SQL
      ...
      SELECT arc.channel_id, arc.sub_channel_id, arc.establishment_id, arc.company_id, arc.cnpj, arc.max_dia_conhecido,
      ...
      SELECT ms.channel_id, ms.sub_channel_id, e.company_id, ca.texto, COUNT(*) AS total
      ...
      CREATE UNIQUE INDEX index_audit_pending_actions ON audit_pending_actions (channel_id, sub_channel_id, company_id, texto);
